...
contract SimpleToken {
     ...
     */
    function sendToken(address _recipient, uint256 _amount) {
...
contract VoteTwoChoices {
     ...
     */
    function vote(uint256 _nbVotes, bytes32 _proposition) {
...
contract BuyToken {
     ...
     */
    function buyToken(uint256 _amount, uint256 _price) payable {
...
contract CountContribution {
     ...
     */
    function recordContribution(address _user, uint256 _amount) {
...
contract DiscountedBuy {
     ...
     */
    function price() constant returns (uint256 price) {
...
contract HeadOrTail {
    ...
    function guess(bool _guessHead) payable {
        ...
        if (_guessHead == lastChoiceHead) msg.sender.transfer(2 ether);
...
contract HeadTail {
     ...
     */
    function resolve(bool _chooseHead, uint256 _randomNumber) {
...
contract Coffers {
     ...
     * */
    function deposit(uint256 _coffer, uint256 _slot) external payable {
     ...
     * */
    function withdraw(uint256 _coffer, uint256 _slot) external {
        Coffer storage coffer = coffers[_coffer];
